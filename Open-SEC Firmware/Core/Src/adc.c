...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC4_MspInit 0 */
    ...
    PB15     ------> ADC4_IN5
    */
    GPIO_InitStruct.Pin = ILS__Pin|ILS_B15_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /* USER CODE END ADC5_MspInit 0 */
    ...
    PA9     ------> ADC5_IN2
    */
    GPIO_InitStruct.Pin = Tamb_Pin|Tsink_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA3     ------> ADC1_IN4
    */
    HAL_GPIO_DeInit(GPIOA, IHS__Pin|IHS_A3_Pin);
  ...
  /* USER CODE END ADC4_MspDeInit 0 */
    ...
    PB15     ------> ADC4_IN5
    */
    HAL_GPIO_DeInit(GPIOB, ILS__Pin|ILS_B15_Pin);
  ...
  /* USER CODE END ADC5_MspDeInit 0 */
    ...
    PA9     ------> ADC5_IN2
    */
    HAL_GPIO_DeInit(GPIOA, Tamb_Pin|Tsink_Pin);
