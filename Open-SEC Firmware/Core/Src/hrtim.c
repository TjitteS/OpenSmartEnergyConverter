...
void MX_HRTIM1_Init(uint32_t TIMER_MUL)
{
  ...
  if (HAL_HRTIM_ADCPostScalerConfig(&hhrtim1, HRTIM_ADCTRIGGER_1, 0xF) != HAL_OK)
  {
    Error_Handler();
  }
  ...
  pCompareCfg.CompareValue = 12500;
...
void HAL_HRTIM_MspPostInit(HRTIM_HandleTypeDef* hrtimHandle)
{
  ...
  /* USER CODE END HRTIM1_MspPostInit 0 */
    ...
    PA11     ------> HRTIM1_CHB2
    */
    GPIO_InitStruct.Pin = P2_PWM___LS_Pin|P2_EN___HS_Pin;
