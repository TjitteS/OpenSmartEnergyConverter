...
modConfig_t defaultConvig = {
		.calData = (CalibrationData_t){
				...
				"0020000",
				false,
				4.68f,//float InputCurrentGain;// A/V
				20.06f,	//float InputCurrentOffset;//mA

				33.89f,	//float InputVoltageGain;// V/V
				7.89f,//float InputVoltageOffset;//mV

				-4.84f,	//float OutputCurrentGain;//  A/V
				-55.52f,	//float OutputCurrentOffset;//mA

				34.00f,	//float OutputVoltageGain;// V/V
				43.0f,	//float OutputVoltageOffset;//mV
				...
				0xddb0,	//uint16_t calcrc; //Checksum
		},
