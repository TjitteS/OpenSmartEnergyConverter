...
#ifndef HARDWARE_HW_SECB808B_H_
#define HARDWARE_HW_SECB808B_H_
...
//Filters
#define VOLTAGE_IN_FORGETING_FACTOR		0.5f
#define VOLTAGE_OUT_FORGETING_FACTOR	0.5f
#define CURRENT_IN_FORGETING_FACTOR     0.0f
#define CURRENT_PV_FORGETING_FACTOR		0.75f
#define TEMP_FORGETING_FACTOR			0.95f

//Limits
#define HW_LIMIT_HS_VOLTAGE_HARD 85000
#define HW_LIMIT_LS_VOLTAGE_HARD 85000
#define HW_LIMIT_HS_CURRENT_HARD 12000
#define HW_LIMIT_LS_CURRENT_HARD 12000
#define HW_MAX_CURRENT_SETTING   8500.0f

#define HW_LIMIT_LS_VOLTAGE_SOFT_MIN  2000.0f
#define HW_LIMIT_LS_CURRENT_SOFT_MIN 0.0f
#define HW_LIMIT_HS_VOLTAGE_SOFT_MIN  10000.0f
#define HW_LIMIT_HS_CURRENT_SOFT_MIN 0.0f

#define HW_SWITCHINGFREQUENCY  188
#define HW_ADC_DELAY           1.5f
#define HW_DEADTIMERISING      10
#define HW_DEADTIMEFALLING     10
#define HW_L                   33e-6f
#define HW_CLOW                119e-6f
